...
<table>
  ...
  <tbody>
    ...
    <tr><td><code>AI_GATEWAY_API_KEY</code></td><td>Vercel AI Gateway key for chat and experimental act. Act requires access to the typesafe-ai provider.</td><td>(none)</td></tr>
    <tr><td><code>AI_GATEWAY_MODEL</code></td><td>Model override for chat and act. Act requires an evaluation model; use its --model flag when this selects a chat model.</td><td>Chat: <code>anthropic/claude-sonnet-4.6</code>; act: <code>typesafe-ai/jev</code></td></tr>
  </tbody>
</table>
